...
organization := "it.gov.***REMOVED***"

name         := "***REMOVED***-storage-manager"
...
dockerCommands                       ~= Docker.updateEnvironment("DAF_STORAGE_MANAGER_ARTIFACT", s"it.gov.***REMOVED***.***REMOVED***-storage-manager-${Versions.defaultVersion}-sans-externalized.jar")

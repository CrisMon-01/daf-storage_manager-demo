...
package ***REMOVED***.catalogmanager
...
object json {
  ...
  implicit lazy val InputSrcReads: Reads[InputSrc] = Reads[InputSrc] {
    json => JsSuccess(InputSrc((json \ "sftp").asOpt[List[SourceSftp]], (json \ "srv_pull").asOpt[List[SourceSrvPull]], (json \ "srv_push").asOpt[List[SourceSrvPush]], (json \ "***REMOVED***_dataset").asOpt[List[SourceDafDataset]]))
  }
  implicit lazy val InputSrcWrites: Writes[InputSrc] = Writes[InputSrc] {
    o => JsObject(Seq("sftp" -> Json.toJson(o.sftp), "srv_pull" -> Json.toJson(o.srv_pull), "srv_push" -> Json.toJson(o.srv_push), "***REMOVED***_dataset" -> Json.toJson(o.***REMOVED***_dataset)).filter(_._2 != JsNull))
  }

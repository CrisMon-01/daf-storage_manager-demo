...
package ***REMOVED***.dataset.export.cleanup

import java.io.FileNotFoundException

import akka.actor.{ Actor, Props }
import config.FileExportConfig
import ***REMOVED***.filesystem.StringPathSyntax
...
class FileExportCleanupActor(pollInterval: FiniteDuration,
  ...
  private val logger = LoggerFactory.getLogger("it.gov.***REMOVED***.ExportCleaner")

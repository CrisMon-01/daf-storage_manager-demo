...
package ***REMOVED***.dataset.export
...
import ***REMOVED***.dataset.ExtraParams
import ***REMOVED***.dataset.export.cleanup.FileExportCleanupActor
import ***REMOVED***.filesystem._
import org.apache.hadoop.fs.{ FileSystem, Path }
import org.apache.livy.client.***REMOVED***.HttpClientFactory
...
class FileExportService(fileExportConfig: FileExportConfig, kuduMaster: String)(implicit actorRefFactory: ActorRefFactory, fileSystem: FileSystem) {
  ...
  /**
    ...
    * @param toFormat the [[***REMOVED***.filesystem.FileDataFormat]] of the expected output file
  ...
  /**
    ...
    * @param fromFormat the [[***REMOVED***.filesystem.FileDataFormat]] of the input file
    * @param toFormat the [[***REMOVED***.filesystem.FileDataFormat]] of the expected output file
    * @param extraParams a `Map[String, String]` of additional parameters to be passed to the export job
    * @return `Future` containing the path to the exported file
    */
  ...
  /**
    * Exports a `file` from a format to another.
    * @param info the [[***REMOVED***.filesystem.PathInfo]] instance of input data, which can be a directory or a file
    * @param toFormat the [[***REMOVED***.filesystem.FileDataFormat]] of the expected output file
    * @param extraParams a `Map[String, String]` of additional parameters to be passed to the export job
    * @return `Future` containing the path to the exported file
    */

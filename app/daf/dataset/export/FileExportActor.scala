...
/**
  ...
  *                 the connection is assumed to be ***REMOVED***, other it will be set to ***REMOVED***
...
class FileExportActor(livyFactory: LivyClientFactory,
  ...
  private val logger = LoggerFactory.getLogger("it.gov.***REMOVED***.ExportActor")

  private val livyClientScheme = if (livySSL) "***REMOVED***" else "***REMOVED***"

...
object Dependencies {
  ...
  object compile {
    ...
    object internal {
      ...
      lazy val common = "it.gov.***REMOVED***" %% "common" % Versions.common
    ...
    val livyClient          = "org.apache.livy"  % "livy-client-***REMOVED***"     % Versions.livyClient
    ...
    val scalaJ              = "org.scalaj"      %% "scalaj-***REMOVED***"          % Versions.scalaJ
